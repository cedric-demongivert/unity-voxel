...
namespace org.rnp.voxel.unity.components.translators
{
  ...
  public sealed class Translators
  {
    ...
    /// </summary>
    /// <param name="style"></param>
    /// <param name="partToTranslate"></param>
    /// <param name="meshToTranslate"></param>
    /// <param name="worldLocation"></param>
    /// <returns></returns>
    public Translator Generate(string style, IVoxelMesh partToTranslate, IVoxelMesh meshToTranslate, VoxelLocation worldLocation)
    {
      ...
      Type translator = this.GetTranslatorFor(style, partToTranslate);
      ...
      componentTranslator.MeshToTranslate = meshToTranslate;
      componentTranslator.PartToTranslate = partToTranslate;
      componentTranslator.PartWorldLocation = worldLocation;
    ...
    /// <param name="meshToTranslate"></param>
    /// <returns></returns>
    private Type GetTranslatorFor(string style, IVoxelMesh meshToTranslate)
    {
